...
| 11 | `find_python_with_deps()` + `run_sdf_tool()` | Subprocess runs run.py in temp dir, deletes any previous target output before launch, and produces a baked PNG without hitting the tool's overwrite prompt. |
