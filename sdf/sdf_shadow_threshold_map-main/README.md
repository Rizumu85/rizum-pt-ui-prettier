...
## Licenses
This project includes third-party libraries such as OpenCV and NumPy.  
All related license texts are provided in the `licenses` folder included in the release package.  