...
For a public GitHub audience beyond Substance Painter, keep the generic PySide6 package prominent and move Painter-specific plugin files, host-preview docks, palette export notes, and SP integration examples into clearly marked documentation or example folders. Non-Painter users should be able to understand and reuse the component library without first learning Painter plugin structure.
