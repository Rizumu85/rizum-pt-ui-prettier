...
class LiquifyPreviewTests(unittest.TestCase):
    ...
    def test_status_banner_scales_its_action_and_updates_in_place(self):
        ...
        self.assertEqual(banner._text_host.objectName(), "RizumStatusTextHost")
        self.assertIn("background: transparent", banner._text_host.styleSheet())
        self.assertEqual(banner._indicator_diameter, 6)
        ...
        self.assertEqual(banner._indicator_diameter, 9)
